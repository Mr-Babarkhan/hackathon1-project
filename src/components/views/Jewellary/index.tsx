...
import JewllaryImage from "@/components/assets/images/jewllery.webp"

const Jewellary = () => {
    return (
        <div className="px-1 text-gray-700 mt-10">
            ...
            <div className="flex flex-col md:flex-row justify-between py-4 mt-2 gap-5">
                ...
                <div className="flex flex-col lg:flex-row basis-1/2">
                    <div className="w-full px-4 lg:px-0 lg:w-80">
                        <Image width={1000} height={1000} src={JewllaryImage} alt={"Designer Jewellery"} />
                    </div>
